...
export default function ContactPageClient() {
  ...
  const handleSubmit = async (event) => {
    ...
    const phone = formData.get("phone")?.trim(); // Added phone to validation
    ...
    // Add a dummy subject for server compatibility if your action expects it
    ...
    try {
      ...
      if (result.success) {
        ...
        // Instead of redirecting to a thank you page, show a success message.
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <>
                      ...
                      >
                        ...
                        <path
                          ...
                          fill="currentColor"
                          d="M4 12a8 8 0 018-8V8H4a8 8 0 018-8z" // Corrected path d attribute for spinner
                        ></path>
                      </svg>
                      Sending...
                    </>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={fadeInUp}
            custom={1} // delay for this section
          >
            <motion.h2
              className="text-2xl font-semibold text-foreground mb-6 flex items-center gap-2"
              initial="hidden"
            ...
            <div className="space-y-4 text-lg text-gray-700 dark:text-gray-300">
              ...
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                custom={8} // Increased delay for this element
              >
                  ...
                  <span className="animate-bounce">
                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
                      <path
                        ...
                        stroke="currentColor" // Use currentColor for primary color
                        strokeWidth="2"
                        strokeLinecap="round"
